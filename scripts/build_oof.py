...
from gas_forecast.oof import OOFResult, SUPPORTED_LEGACY_MODELS, build_legacy_oof, write_oof
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--online-base",
        choices=("persistence", *SUPPORTED_LEGACY_MODELS),
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="每个外层折用于热启动但不计分的 origin 行数；0 表示冷启动",
    )
...
def main() -> None:
    ...
    if args.online_modes:
        ...
        result.report["online_calibration"] = {
            ...
            "warmup_rows_per_fold": args.online_warmup_rows,
            "cold_start": args.online_warmup_rows == 0,
        }
